...
/*   Updated: 2022/02/01 19:55:40 by ivloisy          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(AForm &src) const
{
	...
	{
		std::cout << *this << " couldn’t sign " << src.getName() << " because " << src.getName() << e.what() << std::endl;
	}
...
void	Bureaucrat::executeForm(AForm const &form) const
{
	...
	{
		std::cout << *this << " couldn’t execut " << form.getName() << " because " << form.getName() << e.what() << std::endl;
	}
